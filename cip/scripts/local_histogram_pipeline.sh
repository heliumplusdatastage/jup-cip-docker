...
python /ChestImagingPlatform/cip_python/classification/local_histogram_emphysema.py -i ${cid}.nrrd -m ${cid}_wholeLungLabelMap.nrrd -o ${cid}_localHistogramEmphysema.nrrd -t 8
